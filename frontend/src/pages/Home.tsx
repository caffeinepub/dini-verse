      ...
      <section className="container py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 space-y-6">
            <div>
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-2xl font-bold text-primary">{t('home.recommended')}</h2>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-primary">{t('home.quickStats')}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">{t('home.totalExperiences')}</span>
                  <span className="font-bold">{experiences?.length || 0}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">{t('home.activePlayers')}</span>
                  <span className="font-bold">{t('home.comingSoon')}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">{t('home.creators')}</span>

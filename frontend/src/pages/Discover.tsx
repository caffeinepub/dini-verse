    ...
    <div className="container py-8">
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold tracking-tight">{t('discover.title')}</h1>
          ...
          <>
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-2xl font-bold tracking-tight">{t('discover.trending')}</h2>
              </div>
              <Tabs value={selectedCategory} onValueChange={(value) => setSelectedCategory(value as Category)}>
                <TabsList>
                  <TabsTrigger value={Category.adventure}>{t('discover.categories.adventure')}</TabsTrigger>
                  <TabsTrigger value={Category.roleplay}>{t('discover.categories.roleplay')}</TabsTrigger>
                  <TabsTrigger value={Category.simulator}>{t('discover.categories.simulator')}</TabsTrigger>
                </TabsList>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold tracking-tight">{t('discover.allExperiences')}</h2>
        ...
        {searchTerm && (
          <div className="space-y-4">
            <h2 className="text-2xl font-bold tracking-tight">{t('discover.searchResults')}</h2>
            <ExperienceGrid 
